...
public class TestAccountDao {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("###############################################");
        System.out.println("###############################################");
        output(transferDao.readByAccount(1L, date(16, 10, 2020, 0, 0), date(31, 12, 2020, 23, 59)));
        ...
        System.out.println("###############################################");
        System.out.println("###############################################");
        output(transferDao.readByAccount(2L, date(16, 10, 2020, 0, 0), date(31, 12, 2020, 23, 59)));
        transfer = new Transfer();
        ...
        System.out.println("###############################################");
        System.out.println("###############################################");
        output(transferDao.readByAccount(3L, date(16, 10, 2020, 0, 0), date(31, 12, 2020, 23, 59)));
        transfer = new Transfer();
